  ...
  return (
    ...
    >
      <div className="col-11 col-md-7 mb-5 md-md-0">
        <h3 className="font-poppins text-capitalize text-secondary text-center text-md-start">
          Welcome to
        </h3>
        ...
        <p className="font-inter mt-4 text-center text-md-start">
          ...
          scattered portals and remembering to book your follow up. We have you
          covered.
        </p>
